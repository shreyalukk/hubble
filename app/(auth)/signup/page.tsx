      ...
      <div className="bg-white rounded-2xl shadow-xl border p-8" style={{ borderColor: "#E8DDD0" }}>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <div className="space-y-2">
            <label htmlFor="fullName" className="text-sm font-medium" style={{ color: "#374151" }}>Full Name</label>
        ...
        <p className="text-sm text-center mt-6" style={{ color: "#6b7280" }}>
          ...
          <Link href="/login" className="font-semibold hover:underline" style={{ color: "#1a1a1a" }}>
            Sign in
          </Link>
        </p>
      </div>
